...
public class ubahprofil extends javax.swing.JFrame {
    ...
    public boolean validasi()
    {
        JTextField[] jtf;
         ...
         jtf = new JTextField[]{
            txtnim, txtnama, txtalamat, txtnotelp,
        };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql="update mahasiswa set nim=?,nama=?,alamat=?,notelp=?,jurusan=?,jk=? where nim=?";
                PreparedStatement pst=conn.prepareStatement(sql);
                pst.setString(1, txtnim.getText());
                pst.setString(2, txtnama.getText());
                pst.setString(3, txtalamat.getText());
                pst.setString(4, txtnotelp.getText());
                pst.setString(5, cbjurusan.getSelectedItem().toString());
                pst.setString(6, cbjk.getSelectedItem().toString());
                pst.setString(7, nim);
                pst.executeUpdate();
                
                JOptionPane.showMessageDialog(null, "Sukses mengubah profil, Silahkan login ulang");
                dispose();
                new mahasiswa().dispose();
    ...
    public static javax.swing.JComboBox<String> cbjk;
    public static javax.swing.JComboBox<String> cbjurusan;
